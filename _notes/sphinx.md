...
ファイル /Users/yu9824/center-of-gravity/docs_src/conf.py を作成しています。
ファイル /Users/yu9824/center-of-gravity/docs_src/index.rst を作成しています。
ファイル /Users/yu9824/center-of-gravity/docs_src/Makefile を作成しています。
ファイル /Users/yu9824/center-of-gravity/docs_src/make.bat を作成しています。

終了：初期ディレクトリ構造が作成されました。

マスターファイル /Users/yu9824/center-of-gravity/docs_src/index.rst を作成して
...
```bash
sphinx-apidoc -f -o ./docs_src ./src/center_of_gravity --module-first
```
